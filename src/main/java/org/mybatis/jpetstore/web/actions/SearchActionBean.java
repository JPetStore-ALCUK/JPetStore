...
public class SearchActionBean extends AbstractActionBean {
  ...
  public Long getMinimumPrice(Search search) {
    return search.getMinimumPrice();
  }

  public Long getMaximumPrice(Search search) {
    return search.getMaximumPrice();
  }

  public String getAttribute1(Search search) {
    return search.getAttribute1();
  }

  public String getAttribute2(Search search) {
    return search.getAttribute2();
  }

  public String getAttribute3(Search search) {
    return search.getAttribute3();
  }

  public String getAttribute4(Search search) {
    return search.getAttribute4();
  }
  ...
  public void setAttribute1(String attribute1) {
    search.setAttribute1(attribute1);
  }

  public void setAttribute2(String attribute2) {
    search.setAttribute2(attribute2);
  }

  public void setAttribute3(String attribute3) {
    search.setAttribute3(attribute3);
  }

  public void setAttribute4(String attribute4) {
    search.setAttribute4(attribute4);
  }
  ...
  public List<String> getFishWater() {
    return FISH_WATER;
  }
  ...
  public List<String> getFishTemperature() {
    return FISH_TEMPERATURE;
  }

  public List<String> getCatTemper() {
    return CAT_TEMPER;
  }

  public List<String> getCatDogFurLength() {
    return CAT_DOG_FUR_LENGTH;
  }

  public List<String> getDogTemper() {
    return DOG_TEMPER;
  }

  public List<String> getBirdLifeSpan() {
    return BIRD_LIFESPAN;
  };

  public List<String> getBirdNoise() {
    return BIRD_NOISE;
  }

  public List<String> getReptileTemperature() {
    return REPTILE_TEMPERATURE;
  };

  public List<String> getReptileType() {
    return REPTILE_TYPE;
  }
  ...
  public Resolution continueSearch() {
    return new ForwardResolution(VIEW_SEARCH_FORM);
  }
